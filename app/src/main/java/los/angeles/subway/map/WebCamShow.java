...
public class WebCamShow extends Activity implements OnTouchListener {
  ...
  //      Log.d("2222screeeenWirdthhhhhhh"," is " +disWidth);
        ...
        matrix.setScale(scale,scale);      
	      iv.setImageMatrix(matrix);
	    	...
	    	e.printStackTrace();
	    	startActivity(new Intent(this, Menu2_error.class ));
	     	finish();
//	    		Toast.makeText(getApplicationContext()," Sorry, your phoine does not have enough VM memory  "+e,Toast.LENGTH_LONG).show();
   ...
   //    if(isOnline()) {
    	   id.execute("http://www.bbc.co.uk/travelnews/london/trafficcameras/transportforlondon/0000103115/1369501085494/image"); // } else {
 ...
 // http://lh5.ggpht.com/_Z6tbBnE-swM/TB0CryLkiLI/AAAAAAAAVSo/n6B78hsDUz4/s144-c/_DSC3454.jpg    
       ...
       bt.setOnClickListener(new View.OnClickListener() {
       	...
       	Intent intent = new Intent(WebCamShow.this,WebCamShow.class);
...
//end button calls
    ...
    tv.setText("downloading picture...");
      ...
      //      pd.setProgressStyle(ProgressDialog.STYLE_SPINNER);
    	...
    	//        ImageView iv = (ImageView)findViewById(R.id.remote_image);
    	  //  	onClicky();
    	    	if(count==3){
    	    	//	pd.dismiss();
    	    	tv.setText("Try again later"); // catch all error into text field
    	    //		Log.e("Imagesyyyyyyyyyyyyyy","pppppppppppppppppppppppp");		
    	    	} else {
    	    		tv.setText("Live web cam 1");
            //    pd.dismiss();
    	        if(iv!=null && img!=null){
