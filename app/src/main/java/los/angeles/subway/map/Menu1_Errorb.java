...
public class Menu1_Errorb extends SurfaceView implements SurfaceHolder.Callback{
...
//	private long startTime=0;
	...
	public Menu1_Errorb(Context context) {
		super(context);
		init(context);
	}
	
	public Menu1_Errorb(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public Menu1_Errorb(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context){
		...
		try {
			scene.setFile(context, "menu1_error.jpg");
		} catch (IOException e) {
