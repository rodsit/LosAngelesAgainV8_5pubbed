...
public class Menu14 extends Activity implements OnTouchListener {
	// web cam as of now	
...
//	    		Toast.makeText(getApplicationContext()," Sorry, your phoine does not have enough VM memory  "+e,Toast.LENGTH_LONG).show();
   ...
   //    if(isOnline()) {
    	   id.execute("http://www.bbc.co.uk/travelnews/london/trafficcameras/transportforlondon/0000107369/1369727262562/image"); // } else {
 ...
 // http://lh5.ggpht.com/_Z6tbBnE-swM/TB0CryLkiLI/AAAAAAAAVSo/n6B78hsDUz4/s144-c/_DSC3454.jpg    
       ...
       bt.setOnClickListener(new View.OnClickListener() {
       	...
       	Intent intent = new Intent(Menu14.this,Menu14.class);
