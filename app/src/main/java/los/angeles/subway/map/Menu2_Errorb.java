...
public class Menu2_Errorb extends SurfaceView implements SurfaceHolder.Callback{
...
//	private long startTime=0;
	...
	public Menu2_Errorb(Context context) {
		super(context);
		init(context);
	}
	
	public Menu2_Errorb(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public Menu2_Errorb(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context){
		...
		try {
			scene.setFile(context, "menu2_error.jpg");
		} catch (IOException e) {
